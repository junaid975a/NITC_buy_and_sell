...
const BoughtItemCard = ({ id, name, category, description, seller_id, condition, created_at, price, buyer_id, final_price, purchase_date }) => {
        ...
        <div className="w-[350px] sm:w-[580px] md:w-[740px] lg:w-[980px] h-min m-4 px-4 py-2 flex flex-row rounded-[10px] items-center justify-between shadow-lg">
            ...
            <div className="flex gap-x-3">
                ...
                <div className="my-[10px] mx-[5px] max-w-[310px]">
                    <div className="">
                        <h4 className="text-[#1faa59] text-md font-bold">&#8377; {final_price}</h4>
