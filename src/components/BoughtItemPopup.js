...
const BoughtItemPopup = ({ id, name, category, description, seller_id, condition, created_at, price,onClose, buyer_id, final_price, purchase_date }) => {
                ...
                <div className="flex flex-col justify-between">
                    ...
                    <div className="flex flex-col sm:flex-row">
                        ...
                        <div className="flex flex-col justify-end m-4 p-3 items-start">
                            <h4 className="text-[#1faa59] text-xl font-bold">&#8377; {final_price}</h4>
