                ...
                {soldItems.length === 0 ?
                    ...
                    <div className="flex flex-col justify-center max-w-[1380px] my-0">
                        
                        {
                            ...
                            soldItems.map((item) => (
                                <BoughtItemCard key={item.item_id}
                                    id={item.item_id}
                                    name={item.item_name}
